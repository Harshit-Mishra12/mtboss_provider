...
class BookingFilterLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer4<LanguageProvider,
        BookingProvider,
          ...
          return SizedBox(
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(language(context, value.selectIndex == 0
                    ? translations!.bookingStatus : value.selectIndex == 1
                    ? translations!
                    .selectDateOnly
                                  ...
                                  children: [
                                    ...
                                    SearchTextFieldCommon(
                                      ...
                                      onChanged: (v) {
                                        if (v.isEmpty) {
                                          cat.searchCategory(
                                              context, value.categoryCtrl.text);
                                        }
                                      },
                                      onFieldSubmitted: (v) =>
                                          cat.searchCategory(context, v),)
                                        .padding(bottom: Insets.i15,
                                        horizontal: Insets.i20),
                                    cat.searchCtrl.text.isNotEmpty ? Column(
                                      children: [...cat.searchList
                                          .asMap()
                                          .entries
                                          .map((e) =>
                                          ListTileLayout(
                          ...
                          children: [
                            ...
                            TableCalendar(
                                ...
                                firstDay: DateTime.utc(DateTime
                                    .now()
                                    .year, DateTime.january, DateTime
                                    .now()
                                    .day),
                                ...
                                calendarStyle: CalendarStyle(
                                    ...
                                    todayDecoration: BoxDecoration(
                                        color: appColor(context)
                                            ...
                                            .withOpacity(.10),
                                        shape: BoxShape.circle)))
                                .paddingSymmetric(vertical:
                            Insets.i20, horizontal: Insets.i15)
                                .boxShapeExtension(
                                color: appColor(context).appTheme.fieldCardBg)
                                .paddingSymmetric(horizontal: Insets.i20)
                          ]
                      ))),
                      BottomSheetButtonCommon(textOne: translations!.clearAll,
              ...
              ]).paddingOnly(top: Insets.i20)).bottomSheetExtension(context);
        }
    );
  }
}
