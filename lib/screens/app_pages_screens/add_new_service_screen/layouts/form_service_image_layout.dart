          ...
          children: [
            ContainerWithTextLayout(
                title: language(context,
                    "${language(context, translations!.serviceImages)} (${((value.services != null && value.services!.media != null && value.services!.media!.isNotEmpty ? value.services!.media!.length : 0) + appArray.serviceImageList.length)}/5)(${lang.selectedLocaleService})")),
            ...
            ContainerWithTextLayout(
                    title: language(context, "${translations!.thumbnailImage} (${lang.selectedLocaleService})"))
            ...
            Text(language(context, translations!.theMaximumImage),
                ...
                .paddingSymmetric(horizontal: Insets.i20),
            ContainerWithTextLayout(
                    title: language(context, "${translations!.serviceName} (${lang.selectedLocaleService})"))
                .paddingOnly(top: Insets.i24, bottom: Insets.i12),
            TextFieldCommon(
