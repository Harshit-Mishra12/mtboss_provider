...
class FormCategoryLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<UserDataApiProvider, LanguageProvider>(
      ...
      // log("address.address ::${addressList.last.address}//${addressList.last.area}//${addressList.last.state!.name}//${addressList.last}");
      return Column(children: [
        ...
        ContainerWithTextLayout(
                title: language(context, translations!.perServicemanCommission))
            .paddingOnly(top: Insets.i24, bottom: Insets.i12),
        TextFieldCommon(
                  ...
                  addressList.isEmpty
                      ? Text(language(context, translations!.location),
                          style: appCss.dmDenseMedium14
                              .textColor(appColor(context).appTheme.lightText))
                      : Expanded(
                          child: Text(addressList.last.address.toString(),
        ...
        ContainerWithTextLayout(
                title: language(context,
                    "${translations!.description} (${lang.selectedLocaleService})"))
            .paddingOnly(top: Insets.i24, bottom: Insets.i12),
        CommonDescriptionBox(
            focusNode: value.descriptionFocus, description: value.description),
        ContainerWithTextLayout(
                title: language(context, translations!.timeForCompletion))
            .paddingOnly(top: Insets.i24, bottom: Insets.i12),
        Row(children: [
          Expanded(
              flex: 2,
