...
class DashboardProvider with ChangeNotifier {
  ...
  onReady() async {
    position = LatLng(double.parse(userModel!.primaryAddress!.latitude!),
        double.parse(userModel!.primaryAddress!.longitude!));
    // dashboardList =    appArray.dashboardList(context);
    notifyListeners();
    zoneUpdate();
  }
